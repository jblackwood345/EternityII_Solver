...
namespace EternityII_Solver
{
    public static class Util
    {
        ...
        private static List<int> break_indexes_allowed = new List<int>() { 201, 207, 213, 219, 224, 227, 231, 234, 237, 239 };
        ...
        public static SearchIndex[] Get_Board_Order()
        {
            var board_order = new int[,] {
                    {199,   201,    203,    207,    211,    215,    219,    223,    227,    231,    235,    239,    243,    249,    254,    255},
                    {198,   200,    202,    206,    210,    214,    218,    222,    226,    230,    234,    238,    242,    248,    252,    253},
                    {195,   196,    197,    205,    209,    213,    217,    221,    225,    229,    233,    237,    241,    247,    250,    251},
                    {192,   193,    194,    204,    208,    212,    216,    220,    224,    228,    232,    236,    240,    244,    245,    246},
